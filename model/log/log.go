...
type OperateLog struct {
	...
	UserAgent  string           `gorm:"column:user_agent;notNull;size:100;comment:请求者的UserAgent"`
	AccessTime field.CustomTime `gorm:"column:access_time;autoCreateTime:milli;comment:访问时间"`
